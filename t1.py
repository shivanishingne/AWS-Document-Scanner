...
globalVars = {}
globalVars['Owner'] = "shingne"
globalVars['Environment'] = "Test"
globalVars['REGION_NAME'] = "us-east-1"
globalVars['tagName'] = "Pre-Signed-Url-Generator"
globalVars['BucketName'] = "secure-obj-upload-pvt"
globalVars['GetDefaultExpiry'] = "30"
...
def signed_post_url(event):
    ...
    try:
        ...
        response = {'statusCode': 200,
                    'body': json.dumps(post), 'headers': head}
    except Exception as e:
...
def lambda_handler(event, context):
    if event['body']:
        # to convert the post body back into a dictionary
        bodyData = json.loads(event['body'])
